      ...
      <div>
        ...
        <div className="container">
          ...
          <Switch>
            ...
            <Route path="/:cloudAccountId/Recommendations" component={() => <Recommendations />} />
            <Route path="/:cloudAccountId/Recommendations/:recommendationId" component={() => <RecommendationDetails />} />
